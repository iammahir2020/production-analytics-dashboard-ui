...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // Khata direction: borders-only depth (no ring/shadow), radius
        // matches --radius directly (rounded-lg) not the xl scale step —
        // see .interface-design/system.md and the confirmed specimen.
